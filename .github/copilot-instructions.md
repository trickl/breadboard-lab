...
You are writing a *verbose*, *opinionated*, and *implementation-oriented* planning document for an open-source, web-first breadboard circuit simulator.
...
- Electrical graph/netlist = what the circuit *is*
- Solver = what the circuit *does*
